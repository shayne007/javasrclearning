 ...
 */
@Slf4j
public class RedisRateLimitImpl implements InitializingBean {
    /**
     * 限流器的redis key 前缀
     */
    private static final String RATE_LIMITER_KEY_SUFFIX = "rate_limiter";
    public static final String RATE_LIMITER_LUA_SHA_1 = "lua:sha1:" + RATE_LIMITER_KEY_SUFFIX;
...
//    private ScheduledExecutorService executorService = Executors.newScheduledThreadPool(1);
    ...
    public static class LimiterInfo {
        ...
        public String fullKey() {
            return RATE_LIMITER_KEY_SUFFIX + ":" + type + ":" + key;
        }
...
//        }, 20, 1, TimeUnit.SECONDS);
     ...
     */
    private void initLimitKey(LimiterInfo limiterInfo) {
     ...
     */
    private String cacheRateLimiterSha1() {
