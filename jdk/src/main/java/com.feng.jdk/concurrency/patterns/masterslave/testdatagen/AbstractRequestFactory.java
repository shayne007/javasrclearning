...
public abstract class AbstractRequestFactory implements RequestFactory {
    ...
    public AbstractRequestFactory(Map<String, Integer> respDelayConf, int maxRequestPerTimeslice) {
        super();
    ...
    public long nextRequestTimestamp() {
        ...
        requestTimestamp = nowTimestamp + reqTimeRnd.nextInt((STAT_INTERVAL - 1) * 1000) / 1000;
