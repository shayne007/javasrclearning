...
import com.feng.concurrency.patterns.pipeline.reusable.PipeContext;
...
public class ThreadPoolPipeDecorator<IN, OUT> implements Pipe<IN, OUT> {
    ...
    private static class TerminationToken
        extends com.feng.concurrency.patterns.twophaseterminate.reusable.TerminationToken {
        private final static ConcurrentMap<ExecutorService, TerminationToken> INSTANCES_MAP =
