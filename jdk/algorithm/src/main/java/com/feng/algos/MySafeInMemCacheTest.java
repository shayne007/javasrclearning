 ...
 * @date 3/19/20
 */
public class MySafeInMemCacheTest {

    public static void main(String[] args) throws InterruptedException {
        MySafeInMemCacheTest crunchifyCache = new MySafeInMemCacheTest();
    ...
    private void testAddRemoveObjects() {
        ...
        // maxItems = 6
        MySafeInMemCache<String, String> cache = new MySafeInMemCache<String, String>(200, 500, 6);
    ...
    private void testExpiredCacheObjects() throws InterruptedException {
        ...
        // maxItems = 10
        MySafeInMemCache<String, String> cache = new MySafeInMemCache<String, String>(1, 1, 10);
    ...
    private void testObjectsCleanupTime() throws InterruptedException {
        ...
        MySafeInMemCache<String, String> cache = new MySafeInMemCache<String, String>(100, 100, 500000);
