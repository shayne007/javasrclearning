...
public class TestingDataGen {
    ...
    public void generate(int overallTPS, int duration/* minutes */, Map<String, Map<String, Integer>> respDelayConf) {
        if (duration < 1) {
    ...
    public void doGenerate(int overallTPS, int duration/* minutes */, Map<String, Map<String, Integer>> respDelayConf) {
        ...
        final int maxRequestPerTimeslice = (overallTPS / 3) * AbstractRequestFactory.STAT_INTERVAL;
        final RequestFactory[] factories =
                new RequestFactory[]{new SmsRequestFactory(respDelayConf.get("Sms"), maxRequestPerTimeslice),
                        new ChargingRequestFactory(respDelayConf.get("Charging"), maxRequestPerTimeslice),
                        new LocationRequestFactory(respDelayConf.get("Location"), maxRequestPerTimeslice)};
