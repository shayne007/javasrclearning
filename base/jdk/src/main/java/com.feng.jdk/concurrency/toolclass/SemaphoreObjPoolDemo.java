...
public class SemaphoreObjPoolDemo {
    public static void main(String[] args) {
        // 创建对象池
        ObjPool<Long, String> objPool = new ObjPool<>(10, 23L);
        // 通过对象池获取t，之后执行
        ...
        for (int i = 0; i < 5; i++) {
            threadPool.submit(() -> {
                objPool.exec(t -> {
                    ...
                    ObjPool.printAddresses("Address", t);
                    return t.toString();
                });
            });
        }
    ...
    static class ObjPool<T, R> {
        ...
        public static synchronized void printAddresses(String label, Object... objects) {
