...
public class JedisConnectionConfiguration extends RedisConnectionConfiguration {
    ...
    protected JedisConnectionConfiguration(RedisProperties properties, ObjectProvider<RedisSentinelConfiguration> sentinelConfigurationProvider, ObjectProvider<RedisClusterConfiguration> clusterConfigurationProvider) {
